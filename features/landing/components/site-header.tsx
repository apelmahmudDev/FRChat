...
const chatButtonClassName =
  "group h-10 items-center gap-2 rounded-full bg-[#0a8f55] px-4 text-sm font-bold text-white shadow-[0_8px_22px_rgba(10,143,85,0.2)] transition hover:-translate-y-0.5 hover:bg-[#087a49] focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-[#0a8f55] sm:px-5"
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          {hasSession ? (
            <>
              <Link
                href="/messages"
                className={`${chatButtonClassName} hidden sm:inline-flex`}
              >
                Open messages
            ...
            <Link
              href="/sign-in"
              className={`${chatButtonClassName} inline-flex`}
            >
              Start chatting
              <ArrowUpRight className="size-4 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
            </Link>
